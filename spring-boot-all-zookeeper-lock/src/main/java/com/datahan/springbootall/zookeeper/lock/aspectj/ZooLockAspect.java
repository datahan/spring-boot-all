package com.datahan.springbootall.zookeeper.lock.aspectj;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.datahan.springbootall.zookeeper.lock.annotation.ZooLock)")
    public void doLock() {
...
//                if (!annotation.annotationType().isInstance(LockKeyParam.class)) {
                if (!annotation.annotationType().equals(LockKeyParam.class)) {
                    continue;
                }
